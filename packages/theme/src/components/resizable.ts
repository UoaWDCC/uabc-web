...
export const Resizable: ComponentMultiStyle<"Resizable"> = {
  ...
  variants: {
    ...
    spacer: ({ colorScheme: c = "gray", colorMode: m, orientation: o, theme: t }) => ({
      icon: {
      ...
      trigger: {
        ...
        _active: {
          ...
          _dark: {
            _after: {
              bg: isGray(c) ? "border" : transparentizeColor(`${c}.600`, 0.12)(t, m),
            },
          },
        },
        _after: {
        ...
        _focusVisible: {
          ...
          _dark: {
            _after: {
              bg: isGray(c) ? "border" : transparentizeColor(`${c}.600`, 0.24)(t, m),
            },
          },
        },
      },
