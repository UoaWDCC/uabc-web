...
export const PieChart: ComponentMultiStyle<"PieChart"> = mergeMultiStyle(LineChart, {
  baseStyle: {
    activeShape: {},
    cell: {},
    inactiveShape: {},
  ...
  sizes: {
    sm: ({ theme: t, withLabels, withLegend }) => ({
      container: {
        ...
        w: withLegend
          ? "full"
          : calc.add(get(t, "sizes.3xs"), withLabels ? get(t, "sizes.16") : "0px"),
      },
      label: {
        fontSize: "xs",
      },
    ...
    md: ({ theme: t, withLabels, withLegend }) => ({
      container: {
        ...
        w: withLegend
          ? "full"
          : calc.add(get(t, "sizes.2xs"), withLabels ? get(t, "sizes.16") : "0px"),
      },
      label: {
        fontSize: "sm",
      },
    ...
    lg: ({ theme: t, withLabels, withLegend }) => ({
      container: {
        ...
        w: withLegend
          ? "full"
          : calc.add(get(t, "sizes.xs"), withLabels ? get(t, "sizes.16") : "0px"),
      },
      label: {
        fontSize: "md",
      },
