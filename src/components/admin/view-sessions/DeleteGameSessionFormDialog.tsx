...
export const DeleteGameSessionFormDialog = () => {
  ...
  return (
    <DialogContent>
      ...
      <p className="text-tertiary">Are you sure you want to delete this session?</p>
      <DialogButtonsFooter variant="destructive" disabled={isPending} onClick={handleSubmit} />
    </DialogContent>
  )
}
